...
export declare const wsRequestHandler: (handler: (payload: Record<string, any>, sendMessageToClient: ReturnType<typeof createSendMessageToClient>) => Promise<void>) => (event: APIGatewayProxyEvent) => Promise<void>;
export {};
