...
export declare const wsRequestHandler: (handler: <T>(payload: T, sendMessageToClient: ReturnType<typeof createSendMessageToClient>) => Promise<void>) => (event: APIGatewayProxyEvent) => Promise<void>;
export {};
